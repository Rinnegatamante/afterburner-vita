...
extern int _ZN4FMOD6Studio13EventInstance4stopE21FMOD_STUDIO_STOP_MODE(void *thiz, int mode);
...
extern int *_ZN4FMOD6Studio6System15setNumListenersEi(void *thiz, int numlisteners);
extern void *_ZN4FMOD6Studio6System7releaseEv;
extern void *_ZN4FMOD6Studio6System21setListenerAttributesEiPK18FMOD_3D_ATTRIBUTES(void *thiz, int index, const void *attributes);
extern void *_ZN4FMOD6Studio4Bank6unloadEv;
extern int _ZN4FMOD6Studio6System14loadBankMemoryEPKci28FMOD_STUDIO_LOAD_MEMORY_MODEjPPNS0_4BankE(void *thiz, const char *buffer, int length, int mode, int flags, void **bank);
extern int _ZN4FMOD6Studio6System10initializeEijjPv(void *thiz, int maxchannels, unsigned int studioflags, unsigned int flags, void *extradriverdata);
extern int _ZN4FMOD6Studio6System6updateEv(void *thiz);
extern int _ZN4FMOD6Studio4Bank14loadSampleDataEv(void *thiz);
extern int _ZN4FMOD6Studio6System8getEventEPKcPPNS0_16EventDescriptionE(void *thiz, const char *path, void **event);
extern int _ZN4FMOD6Studio16EventDescription14createInstanceEPPNS0_13EventInstanceE(void *thiz, void **instance);
extern int _ZN4FMOD6Studio13EventInstance5startEv(void *thiz);

int mkdir_soloader(const char *path, mode_t mode);

int FMOD_Studio_System_Create_cpp(void **sys, unsigned int version) {
	sceClibPrintf("FMOD Studio wants %x version\n", version);
	int ret = FMOD_Studio_System_Create(sys, 0x11013);
	if (ret) {
...
void glTexImage2D_hook(GLenum target, GLint level, GLint internalFormat, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid *data) {
	// This is technically not necessary but we do it to ensure more resources can end up into CDRAM
	if (level == 0) {
...
// Game never releases finished instances, resulting in memleak, so let's fix this
...
int stopped_callback(unsigned int type, void *event_instance, void *parameters) {
	sceKernelLockLwMutex(&fmod_mutex, 1, NULL);
	instances_to_release[instances_num++] = event_instance;
	sceKernelUnlockLwMutex(&fmod_mutex, 1);
	return 0;
}
int FMOD_Studio_EventDescription_createInstance_cpp(void *thiz, void **instance) {
	int ret = _ZN4FMOD6Studio16EventDescription14createInstanceEPPNS0_13EventInstanceE(thiz, instance);
	if (ret == 0) {
		_ZN4FMOD6Studio13EventInstance11setCallbackEPF11FMOD_RESULTjP25FMOD_STUDIO_EVENTINSTANCEPvEj(*instance, (void*)&stopped_callback, FMOD_STUDIO_EVENT_CALLBACK_STOPPED);
	}
	return ret;
}
int FMOD_Studio_System_update_cpp(void *thiz) {
	void *to_release[MAX_INSTANCES_NUM];
	int to_release_num;
	...
	instances_num = 0;
	sceKernelUnlockLwMutex(&fmod_mutex, 1);
	for (int i = 0; i < to_release_num; i++) {
		_ZN4FMOD6Studio13EventInstance7releaseEv(to_release[i]);
    }

	return _ZN4FMOD6Studio6System6updateEv(thiz);
}
...
so_default_dynlib default_dynlib[] = {
		...
		{ "_ZN4FMOD6Studio6System15setNumListenersEi", (uintptr_t)&_ZN4FMOD6Studio6System15setNumListenersEi },
		{ "_ZN4FMOD6Studio6System7releaseEv", (uintptr_t)&_ZN4FMOD6Studio6System7releaseEv },
		{ "_ZN4FMOD6Studio6System6updateEv", (uintptr_t)&FMOD_Studio_System_update_cpp },
		...
		{ "_ZN4FMOD6Studio6System14loadBankMemoryEPKci28FMOD_STUDIO_LOAD_MEMORY_MODEjPPNS0_4BankE", (uintptr_t)&_ZN4FMOD6Studio6System14loadBankMemoryEPKci28FMOD_STUDIO_LOAD_MEMORY_MODEjPPNS0_4BankE },
		{ "_ZN4FMOD6Studio4Bank14loadSampleDataEv", (uintptr_t)&_ZN4FMOD6Studio4Bank14loadSampleDataEv  },
		{ "_ZNK4FMOD6Studio6System8getEventEPKcPPNS0_16EventDescriptionE", (uintptr_t)&_ZN4FMOD6Studio6System8getEventEPKcPPNS0_16EventDescriptionE },
		{ "_ZNK4FMOD6Studio16EventDescription14createInstanceEPPNS0_13EventInstanceE", (uintptr_t)&FMOD_Studio_EventDescription_createInstance_cpp },
		...
		{ "acoshf", (uintptr_t)&acoshf },
		{ "asinhf", (uintptr_t)&asinhf },
		{ "atanhf", (uintptr_t)&atanhf },
